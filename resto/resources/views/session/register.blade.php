                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left" method="POST" action="/register">
                                ...
                                {{-- <div class="mb-3">
                    <input type="text" class="form-control" placeholder="user_id" name="user_id" id="user_id" aria-label="user_id" aria-describedby="user_id" value="{{ old('user_id') }}" value="{{ Auth()->id }}">
