                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">
                            @if (Auth()->user()->role)
                            {{Auth()->user()->role->role->designation }}
                            @endif
                        </p>
                    </div>
                </div>
                ...
                <form action="/user-profile" method="POST" role="form text-left">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Location" id="name" name="Adresse" value="{{ auth()->user()->Adresse }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="@error('user.about')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="about" rows="3" placeholder="Say something about yourself" name="desc">{{ auth()->user()->desc }}</textarea>
                        </div>
                    </div>
