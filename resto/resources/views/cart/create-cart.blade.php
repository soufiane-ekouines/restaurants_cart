        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4 mx-4">
                    ...
                    <div class="card-header pb-0">
                        <form role="form text-left" method="POST" action="{{ route('card.store') }}">
                            @csrf
                            <div class="row">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-secondary w-100 my-4 mb-2">create card</button>
                            </div>
