                        ...
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder mb-0">
                                    ...
                                    @if ($totalmonth != 0)
                                        <span
                                            class="text-success text-sm font-weight-bolder">+{{ (int) (($totalday / $totalmonth) * 100) }}%</span>
                                    @endif
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder mb-0">
                                    ...
                                    @if ($monthproduct != 0)
                                        <span
                                            class="text-success text-sm font-weight-bolder">+{{ (int) (($todayproduct / $monthproduct) * 100) }}%</span>
                                    @endif
                                </h5>
                            </div>
                        </div>
                                        ...
                                        @forelse ($products  as $value)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $value->qte }}</span>
                                                </td>
                                                @if (Auth()->user()->role->role->designation == 'Developer')
                                                    <td class="align-middle text-center">
                                                        <span
                                                            class="text-secondary text-xs font-weight-bold">{{ $value->user->name }}</span>
                                                    </td>
                                                @endif
                ...
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                    ...
                    <div class="card-body position-relative z-index-1 p-3">
                        ...
                        <h5 class="text-white mt-4 mb-5 pb-2">
                            {{ $cart == null ? '*********' : $cart->designation }}
                        </h5>
                        <div class="d-flex">
                            <div class="d-flex">
                                <div class="me-4">
                                    <p class="text-white text-sm opacity-8 mb-0">
                                        {{ $cart == null ? '*****************' : $cart->tanks }}
                                    </p>
                                    {{-- <h6 class="text-white mb-0">Jack Peterson</h6> --}}
                                </div>
                                <div>
                                    <p class="text-white text-sm opacity-8 mb-0">
                                        {{ $cart == null ? '******' : $cart->name_wifi }}
                                    </p>
                                    <h6 class="text-white mb-0">{{ $cart == null ? '******' : $cart->password_wifi }}</h6>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="avatar-group mt-2">
                                                <a href="{{ route('user-edit', $item->user_id) }}"
                                                    ...
                                                    data-bs-placement="bottom" title="{{ $item->user->name }}">
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-wrapper w-75 mx-auto">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar {{ $class }} w-{{ $ps }}"
                                                        role="progressbar" aria-valuenow="{{ $ps }}"
                        ...
                        @foreach ($day as $item)
                            <div class="timeline-block mb-3">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0">${{ $item->total }},
                                        {{ $item->designation }}</h6>
